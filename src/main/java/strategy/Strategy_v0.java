...
//идет за оружием, потом атакует врага(подходит/отходит) бегает лечиться
public class Strategy_v0 extends AkaNpouStrategy {
    ...
    private void goToEnemy(Unit unit, Game game, Debug debug, UnitAction action) {
        ...
        action.setVelocity((nearestEnemy.position.x - unit.position.x)*100f);
